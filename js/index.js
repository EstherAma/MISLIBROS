...
fetchBooksJson().then(books =>{
    for (let index = 0;index < books.misLibros.length ;index++)
    {
        ...
        //console.log(books.misLibros[index].titulo);
        ...
        booksSection.innerHTML += `
            <div class="card" style="width: 21rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="buyIt">
                    <a href="https://www.casadellibro.com/libro-la-sombra-de-la-sirena-serie-fjallbacka-6/9788415140924/2109337?q=serie+fjallbacka" class="btn btn-outline-success">Comprar</a>
                </div>    
